...
object LayoutSamples {
    ...
    fun WeightTest() {
        Column {
            Row {
                Column(Modifier.background(Color.Green).weight(1f)) {
                    Text("Title")
                    Text("Subtitle")
                }
                Column(Modifier.background(Color.Blue).weight(1f)) {
                    Text("Title")
                    Text("Subtitle")
                }
            }
            Row {
                Text("This is short text", modifier = Modifier.weight(1f))
